...
def calibrate_mq2(adc):
    """Apply new calibration formula to MQ2_ADC values"""
    return (((adc - 2462.04) / 188.48) * 194.22 + 2017.11).round(2)

def calibrate_mq7(adc):
    """Apply new calibration formula to MQ7_ADC values"""
    return (((adc - 2520.81) / 270.32) * 175.71 + 2027.50).round(2)
...
print("=" * 80)
print("APPLYING NEW CALIBRATION FORMULAS TO ALL DATASET FILES")
print("=" * 80)
