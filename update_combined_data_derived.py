...
# Rename MQ2_PPM and MQ7_PPM to gas and co for consistency with derived columns
df['gas'] = df['MQ2_PPM']
df['co'] = df['MQ7_PPM']

# Recalculate derived columns
print("Recalculating derived columns...")
...
# Remove the temporary gas and co columns (keep MQ2_PPM and MQ7_PPM)
...
sample_cols = ['gas_co_ratio', 'gas_delta', 'co_delta', 'gas_acceleration', 'gas_volatility', 'gas_trend', 'is_gas_accelerating']
